...
class SkarbReviews
{
    ...
    //get parent reviews
    public function getListParentReviewsSk($type = 1, $item_id = 0, $limit = 30, $offset = 0) 
    { 
        $list_id = [];
    ...
    //get childs review
    public function getListChildReviewsSk($type = 1, $item_id = 0, $list_parent = []) 
    { 
        $list_id = [];
    ...
    {       
        ...
        $list_parent = $this->getListParentReviewsSk($type, $item_id, $limit, $offset);
        ...
        if (!empty($list_parent)) {
            $list_child = $this->getListChildReviewsSk($type, $item_id, $list_parent);
